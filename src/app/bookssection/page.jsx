...
function BooksFilterContent() {
  ...
  // ─── 🔄 গ্লোবাল ২ সেকেন্ড ডিবান্স লজিক ───
  useEffect(() => {
...
export default function BookSectionWithFilter() {
  return (
    <>
      ...
      <Suspense
        fallback={
          <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center font-semibold text-gray-500">
            Syncing filter configurations...
          </div>
        }
      >
        <BooksFilterContent />
